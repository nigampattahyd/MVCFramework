        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                createElems: function () {
                    ...
                    O.caption = $('<span>');
                    O.caption1 = $('<div>')
                    O.CaptionCont = $('<p class="CaptionCont" id="spandata"><label><i></i></label></p>').addClass('SelectBox').attr('style', O.E.attr('style')).prepend(O.caption);
                ...
                createLi: function (opt, d) {
                    ...
                    if (O.is_multi) li.prepend('<span><i id="chkmntlist"></i></span>');
